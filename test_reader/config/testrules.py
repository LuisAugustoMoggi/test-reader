class TestRules:
    def __init__(self, test_rules):
        ...
        self.test_description_multiline_regex = self.read_property(test_rules, 'test_description_multiline_regex')
    ...
    def from_parent(self, parent):
        ...
        if self.test_description_multiline_regex is None and parent.test_description_multiline_regex is not None:
            self.test_description_multiline_regex = parent.test_description_multiline_regex
